...
export default function AndroidDevice({ children, width = 412, height = 892, dark = false }: AndroidDeviceProps) {
  return (
    <div style={{
      ...
      <div className="gsm-scroll" style={{ flex: 1, overflow: 'auto', display: 'flex', flexDirection: 'column' }}>
        {children}
      </div>
